...
export const VictoryOverlay = ({ visible, wonAmount }: VictoryOverlayProps) => {
  return (
    <AnimatePresence>
      {visible ? (
        <motion.div
        ...
        >
          ...
          >
            ...
            <h2 className="mt-3 text-2xl font-black text-[#15ff7a] sm:text-4xl">
              VICTORY — YOU WON {wonAmount ? wonAmount.toFixed(2) : "???"} MON
            </h2>
          </motion.div>
        </motion.div>
      ) : null}
